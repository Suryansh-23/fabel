 ...
 */
export const APP_NAME: string = "Fabel";

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = "Social AI Mini App";
 ...
 */
export const APP_TAGS: string[] = ["AI", "Social"];
 ...
 */
export const APP_ACCOUNT_ASSOCIATION: any | undefined = undefined;
 ...
 */
export const APP_BUTTON_TEXT: string = "Imagine";
 ...
 */
export const APP_REQUIRED_CHAINS: string[] = ["eip155:84532"];
